package com.dviltres.multipleroomtables

import android.os.Bundle
import android.util.Log
import androidx.activity.ComponentActivity
import androidx.lifecycle.lifecycleScope
import com.dviltres.multipleroomtables.data.SchoolDatabase
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            ...
            schoolWithDirector.forEach {
                Log.d("TAG", "School:${it.school.schoolName}, Director:${it.director.directorName}")
            }


            val schoolWithStudents = dao.getSchoolWithStudents("Kotlin School")
            schoolWithStudents.forEach {
                Log.d("TAG", "School:${it.school.schoolName}, Students:${it.students.map { student->
                    student.studentName
                }}")
            }
        }
